...
export const RATE_LIMITS = {
  ...
  /** Anonymous makson.space lead intake, keyed per one-way request fingerprint. */
  publicLeadIntake: { limit: 8, windowMs: 10 * 60_000 },
  /** Anonymous full financial questionnaire. Lower volume, larger payload. */
  publicFinancialQuestionnaire: { limit: 5, windowMs: 10 * 60_000 },
